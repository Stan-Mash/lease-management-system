<div class="cb-login-wrap">
    ...
    {{-- LEFT PANEL — Nairobi photo + brand content --}}
    ...
    {{-- RIGHT PANEL — plain white login card --}}
...
/* Overlay: lighter in the middle so city shows through, darker top/bottom for text */
.cb-left-photo-overlay {
    position: absolute; inset: 0;
    background: linear-gradient(
        to bottom,
        rgba(10,18,35,0.55) 0%,
        rgba(10,18,35,0.30) 30%,
        rgba(10,18,35,0.25) 60%,
...
.cb-logo-img   { height: 56px; width: auto; filter: drop-shadow(0 2px 6px rgba(0,0,0,0.5)); }
.cb-logo-badge {
    margin-top: .9rem; display: inline-flex; align-items: center; gap: 6px;
    background: rgba(0,0,0,0.40); border: 1px solid rgba(218,165,32,.55);
    border-radius: 99px; padding: 4px 14px; backdrop-filter: blur(6px);
}
...
.cb-accent-bar  { height: 3px; width: 48px; border-radius: 99px; background: linear-gradient(90deg,#DAA520,#f0c040); }
.cb-accent-fade { height: 1px; flex: 1; background: linear-gradient(90deg,rgba(218,165,32,.6),transparent); }

.cb-heading     {
    font-size: 2.8rem; font-weight: 800; line-height: 1.15; color: #ffffff;
...
.cb-subheading {
    color: rgba(255,255,255,0.82); font-size: .95rem; line-height: 1.75;
    max-width: 360px; margin: 0 0 2.4rem;
    text-shadow: 0 1px 6px rgba(0,0,0,0.5);
}

/* Feature list */
.cb-features    { display: flex; flex-direction: column; gap: .75rem; }
.cb-feature-row { display: flex; align-items: center; gap: .85rem; }
.cb-feature-icon {
    flex-shrink: 0; width: 38px; height: 38px; border-radius: 10px;
    display: flex; align-items: center; justify-content: center; font-size: 1rem;
    background: rgba(0,0,0,0.35); border: 1px solid rgba(218,165,32,.5);
    backdrop-filter: blur(4px);
    box-shadow: 0 2px 8px rgba(0,0,0,0.2);
}
.cb-feature-text {
    color: rgba(255,255,255,0.90); font-size: .88rem; font-weight: 500;
    text-shadow: 0 1px 4px rgba(0,0,0,0.5);
}

/* Footer */
.cb-left-footer {
    flex-shrink: 0; padding: 1.1rem 3rem;
    display: flex; align-items: center; justify-content: space-between;
    background: rgba(0,0,0,0.38); backdrop-filter: blur(8px);
    border-top: 1px solid rgba(218,165,32,.22);
}
.cb-footer-copy { color: rgba(255,255,255,0.55); font-size: .72rem; margin: 0; }
...
.cb-online-text { color: rgba(255,255,255,0.55); font-size: .72rem; }
...
.cb-right-panel {
    ...
    background: #ffffff; overflow-y: auto; padding: 3rem 1.5rem;
}
