...
class LeaseSignedConfirmationNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject("Your Lease Agreement — {$reference}")
            ->greeting("Dear {$tenantName},")
            ->line('Your lease agreement with Chabrin Agencies is now fully executed. Please find your signed lease attached to this email.')
            ->line('')
            ...
            ->line('')
            ->line('Please keep this email and the attached lease document for your records.')
            ->line('')
            ->line('If you have any questions, please contact Chabrin Agencies at support@chabrin.com or call our office directly.')
