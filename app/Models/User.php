...
class User extends Authenticatable implements FilamentUser
{
    ...
    protected $fillable = [
        ...
        // CHIPS columns (renamed from Chabrin)
        'block',              // was is_active (inverted: 0=active, 1=blocked)
        'lastvisitDate',      // was last_login_at
        'registerDate',       // was date_created

        // Chabrin-specific columns (kept)
        'department',
        'bio',
        'availability_status',
        'backup_officer_id',
    ...
    public function canAccessLease(Lease $lease): bool
    {
        ...
        // Property managers and asst PMs can access all leases
        if (in_array($this->role, ['property_manager', 'asst_property_manager'])) {
            return true;
        }
    ...
    /**
     * Backward compatibility: is_active (inverted from block).
     * block=false (0) means active, block=true (1) means blocked.
     */
