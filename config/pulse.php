...
use App\Pulse\Recorders\ChipsDatabaseRecorder;
use App\Pulse\Recorders\SmsBalanceRecorder;
    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\Servers::class => [
            // Disabled on Windows due to wmic deprecation - enable on Linux production
            'enabled' => env('PULSE_SERVERS_ENABLED', PHP_OS_FAMILY !== 'Windows'),
        ...
        /*
        |--------------------------------------------------------------------------
        | Chabrin Custom Recorders
        |--------------------------------------------------------------------------
        |
        | Custom recorders for monitoring external dependencies:
        | - SMS Balance: Africa's Talking account balance monitoring
        | - CHIPS Database: Financial system connectivity health
        |
        */

        SmsBalanceRecorder::class => [
            'enabled' => env('PULSE_SMS_BALANCE_ENABLED', true),
            // Alert threshold in KES - warn when balance falls below this
            'alert_threshold' => env('PULSE_SMS_BALANCE_THRESHOLD', 1000),
        ],

        ChipsDatabaseRecorder::class => [
            'enabled' => env('PULSE_CHIPS_DB_ENABLED', true),
            // Database connection name for CHIPS
            'connection' => env('PULSE_CHIPS_DB_CONNECTION', 'chips_db'),
            // Query timeout in seconds
            'timeout' => env('PULSE_CHIPS_DB_TIMEOUT', 5),
        ],
    ],
];
